...
function AdminLogin() {
  ...
  const handleSubmit = async (e) => {   
    ...
    try {
      const admin = userRole.find(role => role.userId === userId);
      
      if (admin && admin.roleName === 'user') {
        setSnackbarMessage("This admin is not authorized.");
        setSnackbarSeverity('error'); 
        setOpenSnackbar(true);
      } else { 
      ...
      setSnackbarMessage("Login failed: Password or username is incorrect.");
      setSnackbarSeverity('error');
      setOpenSnackbar(true); 
    }
  };
